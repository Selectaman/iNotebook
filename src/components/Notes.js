  ...
  return (
    <>
            ...
            <div className="modal-body">
              <form>
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" id="etitle" name="etitle" value={note.etitle} aria-describedby="emailHelp" onChange={handleOnChange} minLength={3} required/>
                </div>
                <div className="mb-3">
      ...
      <div className="container mx-2">
        {notes.length===0 && <p>There is no Note to display</p>}
        </div>             
        {notes.map((note) => {
